...
QT_MOC_LITERAL(5, 46, 8) // "finished"
    ...
    "WorkerThread\0notify\0\0LanTableRecord*\0"
    "ltRecord\0finished"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (WorkerThread::*_t)(LanTableRecord * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::notify)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::finished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::notify(LanTableRecord * _t1)
{
